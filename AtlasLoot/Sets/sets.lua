AtlasLoot_Data["AtlasLootSetItems"] = {
	...
	T1Mage = {
		...
		{ 0, "", "", "" },
		{ 25143, "INV_Helmet_53", "=q4=Arcanist Crown", "=ds=#s1#, #a1# =q7=#db28#" },
		{ 25140, "INV_Shoulder_02", "=q4=Arcanist Mantle", "=ds=#s3#, #a1# =q7=#db29#" },
		{ 25142, "INV_Chest_Cloth_03", "=q4=Arcanist Robes", "=ds=#s5#, #a1# =q7=#db32#" },
		{ 25136, "INV_Belt_29", "=q4=Arcanist Bindings", "=ds=#s8#, #a1# =q7=#x34# (#z1#)" },
		{ 25138, "INV_Gauntlets_14", "=q4=Arcanist Gloves", "=ds=#s10#, #a1# =q7=#db30#" },
		{ 25137, "INV_Belt_30", "=q4=Arcanist Belt", "=ds=#s10#, #a1# =q7=#x34# (#z1#)" },
		{ 25141, "INV_Pants_08", "=q4=Arcanist Leggings", "=ds=#s11#, #a1# =q7=#db26#" },
		{ 25139, "INV_Boots_07", "=q4=Arcanist Slippers", "=ds=#s12#, #a1# =q7=#db25#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 25151, "INV_Helmet_53", "=q4=Netherwind Crown", "=ds=#s1#, #a1# =q7=#db28#" },
		{ 25148, "INV_Shoulder_02", "=q4=Netherwind Mantle", "=ds=#s3#, #a1# =q7=#db29#" },
		{ 25150, "INV_Chest_Cloth_03", "=q4=Netherwind Robes", "=ds=#s5#, #a1# =q7=#db32#" },
		{ 25144, "INV_Belt_29", "=q4=Netherwind Bindings", "=ds=#s8#, #a1# =q7=#x34# (#z1#)" },
		{ 25146, "INV_Gauntlets_14", "=q4=Netherwind Gloves", "=ds=#s10#, #a1# =q7=#db30#" },
		{ 25145, "INV_Belt_30", "=q4=Netherwind Belt", "=ds=#s10#, #a1# =q7=#x34# (#z1#)" },
		{ 25149, "INV_Pants_08", "=q4=Netherwind Pants", "=ds=#s11#, #a1# =q7=#db26#" },
		{ 25147, "INV_Boots_07", "=q4=Netherwind Boots", "=ds=#s12#, #a1# =q7=#db25#" },
	};
	T1Priest = {
		{ 0, "", "", "" },
		{ 0, "Spell_Holy_PowerWordShield", "=q9=#t1s5#", "" },
		{ 0, "", "", "" },
		{ 25175, "INV_Helmet_34", "=q4=Circlet of Prophecy", "=ds=#s1#, #a1# =q7=#db28#" },
		{ 25172, "INV_Shoulder_02", "=q4=Mantle of Prophecy", "=ds=#s3#, #a1# =q7=#db31#" },
		{ 25174, "INV_Chest_Cloth_03", "=q4=Robes of Prophecy", "=ds=#s5#, #a1# =q7=#db32#" },
		{ 25168, "INV_Bracer_09", "=q4=Vambraces of Prophecy", "=ds=#s8#, #a1# =q7=#x34# (#z1#)" },
		{ 25170, "INV_Gauntlets_14", "=q4=Gloves of Prophecy", "=ds=#s10#, #a1# =q7=#db27#" },
		{ 25169, "INV_Belt_22", "=q4=Girdle of Prophecy", "=ds=#s10#, #a1# =q7=#x34# (#z1#)" },
		{ 25173, "INV_Pants_08", "=q4=Pants of Prophecy", "=ds=#s11#, #a1# =q7=#db26#" },
		{ 25171, "INV_Boots_07", "=q4=Boots of Prophecy", "=ds=#s12#, #a1# =q7=#db30#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 25183, "INV_Helmet_34", "=q4=Halo of Transcendence", "=ds=#s1#, #a1# =q7=#db28#" },
		{ 25180, "INV_Shoulder_02", "=q4=Pauldrons of Transcendence", "=ds=#s3#, #a1# =q7=#db31#" },
		{ 25182, "INV_Chest_Cloth_03", "=q4=Robes of Transcendence", "=ds=#s5#, #a1# =q7=#db32#" },
		{ 25176, "INV_Bracer_09", "=q4=Bindings of Transcendence", "=ds=#s8#, #a1# =q7=#x34# (#z1#)" },
		{ 25178, "INV_Gauntlets_14", "=q4=Handguards of Transcendence", "=ds=#s10#, #a1# =q7=#db27#" },
		{ 25177, "INV_Belt_22", "=q4=Belt of Transcendence", "=ds=#s10#, #a1# =q7=#x34# (#z1#)" },
		{ 25181, "INV_Pants_08", "=q4=Leggings of Transcendence", "=ds=#s11#, #a1# =q7=#db26#" },
		{ 25179, "INV_Boots_07", "=q4=Boots of Transcendence", "=ds=#s12#, #a1# =q7=#db30#" },
	};
	T1Warlock = {
		{ 0, "", "", "" },
		{ 0, "Spell_Shadow_CurseOfTounges", "=q11=#t1s8#", "" },
		{ 0, "", "", "" },
		{ 25159, "INV_Helmet_08", "=q4=Felheart Horns", "=ds=#s1#, #a1# =q7=#db28#" },
		{ 25156, "INV_Shoulder_23", "=q4=Felheart Shoulder Pads", "=ds=#s3#, #a1# =q7=#db29#" },
		{ 25158, "INV_Chest_Cloth_09", "=q4=Felheart Robes", "=ds=#s5#, #a1# =q7=#db32#" },
		{ 25152, "INV_Bracer_07", "=q4=Felheart Bracers", "=ds=#s8#, #a1# =q7=#x34# (#z1#)" },
		{ 25154, "INV_Gauntlets_19", "=q4=Felheart Gloves", "=ds=#s10#, #a1# =q7=#db25#" },
		{ 25153, "INV_Belt_13", "=q4=Felheart Belt", "=ds=#s10#, #a1# =q7=#x34# (#z1#)" },
		{ 25157, "INV_Pants_Cloth_14", "=q4=Felheart Pants", "=ds=#s11#, #a1# =q7=#db26#" },
		{ 25155, "INV_Boots_Cloth_05", "=q4=Felheart Slippers", "=ds=#s12#, #a1# =q7=#db30#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 25167, "INV_Helmet_08", "=q4=Nemesis Skullcap", "=ds=#s1#, #a1# =q7=#db28#" },
		{ 25164, "INV_Shoulder_23", "=q4=Nemesis Spaulders", "=ds=#s3#, #a1# =q7=#db29#" },
		{ 25166, "INV_Chest_Cloth_09", "=q4=Nemesis Robes", "=ds=#s5#, #a1# =q7=#db32#" },
		{ 25160, "INV_Bracer_07", "=q4=Nemesis Bracers", "=ds=#s8#, #a1# =q7=#x34# (#z1#)" },
		{ 25162, "INV_Gauntlets_19", "=q4=Nemesis Gloves", "=ds=#s10#, #a1# =q7=#db25#" },
		{ 25161, "INV_Belt_13", "=q4=Nemesis Belt", "=ds=#s10#, #a1# =q7=#x34# (#z1#)" },
		{ 25165, "INV_Pants_Cloth_14", "=q4=Nemesis Leggings", "=ds=#s11#, #a1# =q7=#db26#" },
		{ 25163, "INV_Boots_Cloth_05", "=q4=Nemesis Boots", "=ds=#s12#, #a1# =q7=#db30#" },
	...
	T1Rogue = {
		...
		{ 0, "", "", "" },
		{ 25127, "INV_Helmet_41", "=q4=Nightslayer Cover", "=ds=#s1#, #a2# =q7=#db28#" },
		{ 25124, "INV_Shoulder_25", "=q4=Nightslayer Shoulder Pads", "=ds=#s3#, #a2# =q7=#db31#" },
		{ 25126, "INV_Chest_Cloth_07", "=q4=Nightslayer Chestpiece", "=ds=#s5#, #a2# =q7=#db32#" },
		{ 25120, "INV_Bracer_02", "=q4=Nightslayer Bracelets", "=ds=#s8#, #a2# =q7=#x34# (#z1#)" },
		{ 25122, "INV_Gauntlets_21", "=q4=Nightslayer Gloves", "=ds=#s10#, #a2# =q7=#db27#" },
		{ 25121, "INV_Belt_23", "=q4=Nightslayer Belt", "=ds=#s10#, #a2# =q7=#x34# (#z1#)" },
		{ 25125, "INV_Pants_06", "=q4=Nightslayer Pants", "=ds=#s11#, #a2# =q7=#db26#" },
		{ 25123, "INV_Gauntlets_08", "=q4=Nightslayer Boots", "=ds=#s12#, #a2# =q7=#db30#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 25135, "INV_Helmet_41", "=q4=Bloodfang Hood", "=ds=#s1#, #a2# =q7=#db28#" },
		{ 25132, "INV_Shoulder_25", "=q4=Bloodfang Spaulders", "=ds=#s3#, #a2# =q7=#db31#" },
		{ 25134, "INV_Chest_Cloth_07", "=q4=Bloodfang Chestpiece", "=ds=#s5#, #a2# =q7=#db32#" },
		{ 25128, "INV_Bracer_02", "=q4=Bloodfang Bracers", "=ds=#s8#, #a2# =q7=#x34# (#z1#)" },
		{ 25130, "INV_Gauntlets_21", "=q4=Bloodfang Gloves", "=ds=#s10#, #a2# =q7=#db27#" },
		{ 25129, "INV_Belt_23", "=q4=Bloodfang Belt", "=ds=#s10#, #a2# =q7=#x34# (#z1#)" },
		{ 25133, "INV_Pants_06", "=q4=Bloodfang Pants", "=ds=#s11#, #a2# =q7=#db26#" },
		{ 25131, "INV_Gauntlets_08", "=q4=Bloodfang Boots", "=ds=#s12#, #a2# =q7=#db30#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
	...
	T1Druid1 = {
		...
		{ 0, "", "", "" },
		{ 25095, "INV_Helmet_09", "=q4=Cenarion Horns", "=ds=#s1#, #a2# =q7=#db28#" },
		{ 25092, "INV_Shoulder_07", "=q4=Cenarion Spaulders", "=ds=#s3#, #a2# =q7=#db29#" },
		{ 25094, "INV_Chest_Cloth_06", "=q4=Cenarion Vestments", "=ds=#s5#, #a2# =q7=#db32#" },
		{ 25088, "INV_Bracer_03", "=q4=Cenarion Bracers", "=ds=#s8#, #a2# =q7=#x34# (#z1#)" },
		{ 25090, "INV_Gauntlets_07", "=q4=Cenarion Handgaurds", "=ds=#s10#, #a2# =q7=#db30#" },
		{ 25089, "INV_Belt_06", "=q4=Cenarion Belt", "=ds=#s10#, #a2# =q7=#x34# (#z1#)" },
		{ 25093, "INV_Pants_06", "=q4=Cenarion Leggings", "=ds=#s11#, #a2# =q7=#db26#" },
		{ 25091, "INV_Boots_08", "=q4=Cenarion Boots", "=ds=#s12#, #a2# =q7=#db25#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 25103, "INV_Helmet_09", "=q4=Talonclaw Helm", "=ds=#s1#, #a2# =q7=#db28#" },
		{ 25100, "INV_Shoulder_07", "=q4=Talonclaw Spaulders", "=ds=#s3#, #a2# =q7=#db29#" },
		{ 25102, "INV_Chest_Cloth_06", "=q4=Talonclaw Vestments", "=ds=#s5#, #a2# =q7=#db32#" },
		{ 25096, "INV_Bracer_03", "=q4=Talonclaw Bracers", "=ds=#s8#, #a2# =q7=#x34# (#z1#)" },
		{ 25098, "INV_Gauntlets_07", "=q4=Talonclaw Gloves", "=ds=#s10#, #a2# =q7=#db30#" },
		{ 25097, "INV_Belt_06", "=q4=Talonclaw Belt", "=ds=#s10#, #a2# =q7=#x34# (#z1#)" },
		{ 25101, "INV_Pants_06", "=q4=Talonclaw Leggings", "=ds=#s11#, #a2# =q7=#db26#" },
		{ 25099, "INV_Boots_08", "=q4=Talonclaw Sabatons", "=ds=#s12#, #a2# =q7=#db25#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
	...
	T1Druid2 = {
		...
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 25111, "INV_Helmet_09", "=q4=Ursoc Helm", "=ds=#s1#, #a2# =q7=#db28#" },
		{ 25108, "INV_Shoulder_07", "=q4=Ursoc Shoulderguards", "=ds=#s3#, #a2# =q7=#db29#" },
		{ 25110, "INV_Chest_Cloth_06", "=q4=Ursoc Raiments", "=ds=#s5#, #a2# =q7=#db32#" },
		{ 25104, "INV_Bracer_03", "=q4=Ursoc Armguards", "=ds=#s8#, #a2# =q7=#x34# (#z1#)" },
		{ 25106, "INV_Gauntlets_07", "=q4=Ursoc Gauntlets", "=ds=#s10#, #a2# =q7=#db30#" },
		{ 25105, "INV_Belt_06", "=q4=Ursoc Belt", "=ds=#s10#, #a2# =q7=#x34# (#z1#)" },
		{ 25109, "INV_Pants_06", "=q4=Ursoc Legguards", "=ds=#s11#, #a2# =q7=#db26#" },
		{ 25107, "INV_Boots_08", "=q4=Ursoc Greaves", "=ds=#s12#, #a2# =q7=#db25#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 25119, "INV_Helmet_09", "=q4=Stormrage Cover", "=ds=#s1#, #a2# =q7=#db28#" },
		{ 25116, "INV_Shoulder_07", "=q4=Stormrage Pauldrons", "=ds=#s3#, #a2# =q7=#db29#" },
		{ 25118, "INV_Chest_Cloth_06", "=q4=Stormrage Chestguard", "=ds=#s5#, #a2# =q7=#db32#" },
		{ 25112, "INV_Bracer_03", "=q4=Stormrage Bracers", "=ds=#s8#, #a2# =q7=#x34# (#z1#)" },
		{ 25114, "INV_Gauntlets_07", "=q4=Stormrage Handguards", "=ds=#s10#, #a2# =q7=#db30#" },
		{ 25113, "INV_Belt_06", "=q4=Stormrage Belt", "=ds=#s10#, #a2# =q7=#x34# (#z1#)" },
		{ 25117, "INV_Pants_06", "=q4=Stormrage Legguards", "=ds=#s11#, #a2# =q7=#db26#" },
		{ 25115, "INV_Boots_08", "=q4=Stormrage Boots", "=ds=#s12#, #a2# =q7=#db25#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
	...
	T1Shaman1 = {
		...
		{ 0, "", "", "" },
		{ 25047, "INV_Helmet_09", "=q4=Earthfury Helmet", "=ds=#s1#, #a3# =q7=#db28#" },
		{ 25044, "INV_Shoulder_29", "=q4=Earthfury Epaulets", "=ds=#s3#, #a3# =q7=#db29#" },
		{ 25046, "INV_Chest_Chain_11", "=q4=Earthfury Vestments", "=ds=#s5#, #a3# =q7=#db32#" },
		{ 25040, "INV_Bracer_16", "=q4=Earthfury Bracers", "=ds=#s8#, #a3# =q7=#x34# (#z1#)" },
		{ 25042, "INV_Gauntlets_11", "=q4=Earthfury Gauntlets", "=ds=#s10#, #a3# =q7=#db27#" },
		{ 25041, "INV_Belt_14", "=q4=Earthfury Belt", "=ds=#s10#, #a3# =q7=#x34# (#z1#)" },
		{ 25045, "INV_Pants_03", "=q4=Earthfury Legguards", "=ds=#s11#, #a3# =q7=#db26#" },
		{ 25043, "INV_Boots_Plate_06", "=q4=Earthfury Boots", "=ds=#s12#, #a3# =q7=#db25#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 25055, "INV_Helmet_09", "=q4=Cataclysm Helmet", "=ds=#s1#, #a3# =q7=#db28#" },
		{ 25052, "INV_Shoulder_29", "=q4=Cataclysm Epaulets", "=ds=#s3#, #a3# =q7=#db29#" },
		{ 25054, "INV_Chest_Chain_11", "=q4=Cataclysm Vestments", "=ds=#s5#, #a3# =q7=#db32#" },
		{ 25048, "INV_Bracer_16", "=q4=Cataclysm Bracers", "=ds=#s8#, #a3# =q7=#x34# (#z1#)" },
		{ 25050, "INV_Gauntlets_11", "=q4=Cataclysm Gauntlets", "=ds=#s10#, #a3# =q7=#db27#" },
		{ 25049, "INV_Belt_14", "=q4=Cataclysm Belt", "=ds=#s10#, #a3# =q7=#x34# (#z1#)" },
		{ 25053, "INV_Pants_03", "=q4=Cataclysm Legguards", "=ds=#s11#, #a3# =q7=#db26#" },
		{ 25051, "INV_Boots_Plate_06", "=q4=Cataclysm Boots", "=ds=#s12#, #a3# =q7=#db25#" },
	};
	T1Shaman2 = {
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 25071, "INV_Helmet_09", "=q4=Stonefury Helmet", "=ds=#s1#, #a3# =q7=#db28#" },
		{ 25068, "INV_Shoulder_29", "=q4=Stonefury Shoulderplates", "=ds=#s3#, #a3# =q7=#db29#" },
		{ 25070, "INV_Chest_Chain_11", "=q4=Stonefury Chestguard", "=ds=#s5#, #a3# =q7=#db32#" },
		{ 25064, "INV_Bracer_16", "=q4=Stonefury Armguards", "=ds=#s8#, #a3# =q7=#x34# (#z1#)" },
		{ 25066, "INV_Gauntlets_11", "=q4=Stonefury Gauntlets", "=ds=#s10#, #a3# =q7=#db27#" },
		{ 25065, "INV_Belt_14", "=q4=Stonefury Belt", "=ds=#s10#, #a3# =q7=#x34# (#z1#)" },
		{ 25069, "INV_Pants_03", "=q4=Stonefury Kilt", "=ds=#s11#, #a3# =q7=#db26#" },
		{ 25067, "INV_Boots_Plate_06", "=q4=Stonefury Greaves", "=ds=#s12#, #a3# =q7=#db25#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 25063, "INV_Helmet_09", "=q4=Helmet of Ten Stones", "=ds=#s1#, #a3# =q7=#db28#" },
		{ 25060, "INV_Shoulder_29", "=q4=Epaulets of Ten Storms", "=ds=#s3#, #a3# =q7=#db29#" },
		{ 25062, "INV_Chest_Chain_11", "=q4=Breastplate of Ten Storms", "=ds=#s5#, #a3# =q7=#db32#" },
		{ 25056, "INV_Bracer_16", "=q4=Bracers of Ten Storms", "=ds=#s8#, #a3# =q7=#x34# (#z1#)" },
		{ 25058, "INV_Gauntlets_11", "=q4=Gauntlets of Ten Storms", "=ds=#s10#, #a3# =q7=#db27#" },
		{ 25057, "INV_Belt_14", "=q4=Belt of Ten Storms", "=ds=#s10#, #a3# =q7=#x34# (#z1#)" },
		{ 25061, "INV_Pants_03", "=q4=Kilt of Ten Storms", "=ds=#s11#, #a3# =q7=#db26#" },
		{ 25059, "INV_Boots_Plate_06", "=q4=Greaves of Ten Storms", "=ds=#s12#, #a3# =q7=#db25#" },
	};
	T1Hunter = {
		{ 0, "", "", "" },
		{ 0, "Ability_Hunter_RunningShot", "=q14=#t1s2#", "" },
		{ 0, "", "", "" },
		{ 25079, "INV_Helmet_05", "=q4=Giantstalker's Helmet", "=ds=#s1#, #a3# =q7=#db28#" },
		{ 25076, "INV_Shoulder_10", "=q4=Giantstalker's Epaulets", "=ds=#s3#, #a3# =q7=#db31#" },
		{ 25078, "INV_Chest_Chain_03", "=q4=Giantstalker's Breastplate", "=ds=#s5#, #a3# =q7=#db32#" },
		{ 25072, "INV_Bracer_17", "=q4=Giantstalker's Bracers", "=ds=#s8#, #a3# =q7=#x34# (#z1#)" },
		{ 25074, "INV_Gauntlets_10", "=q4=Giantstalker's Gloves", "=ds=#s10#, #a3# =q7=#db30#" },
		{ 25073, "INV_Belt_28", "=q4=Giantstalker's Belt", "=ds=#s10#, #a3# =q7=#x34# (#z1#)" },
		{ 25077, "INV_Pants_Mail_03", "=q4=Giantstalker's Leggings", "=ds=#s11#, #a3# =q7=#db26#" },
		{ 25075, "INV_Boots_Chain_13", "=q4=Giantstalker's Boots", "=ds=#s12#, #a3# =q7=#db27#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 25087, "INV_Helmet_05", "=q4=Dragonstalker's Helm", "=ds=#s1#, #a3# =q7=#db28#" },
		{ 25084, "INV_Shoulder_10", "=q4=Dragonstalker's Spaulders", "=ds=#s3#, #a3# =q7=#db31#" },
		{ 25086, "INV_Chest_Chain_03", "=q4=Dragonstalker's Chestpiece", "=ds=#s5#, #a3# =q7=#db32#" },
		{ 25080, "INV_Bracer_17", "=q4=Dragonstalker's Bracers", "=ds=#s8#, #a3# =q7=#x34# (#z1#)" },
		{ 25082, "INV_Gauntlets_10", "=q4=Dragonstalker's Gauntlets", "=ds=#s10#, #a3# =q7=#db30#" },
		{ 25081, "INV_Belt_28", "=q4=Dragonstalker's Belt", "=ds=#s10#, #a3# =q7=#x34# (#z1#)" },
		{ 25085, "INV_Pants_Mail_03", "=q4=Dragonstalker's Legguards", "=ds=#s11#, #a3# =q7=#db26#" },
		{ 25083, "INV_Boots_Chain_13", "=q4=Dragonstalker's Greaves", "=ds=#s12#, #a3# =q7=#db27#" },
	};
	T1Warrior = {
		{ 0, "", "", "" },
		{ 0, "INV_Shield_05", "=q17=#t1s9#", "" },
		{ 0, "", "", "" },
		{ 25007, "INV_Helmet_09", "=q4=Faceguard of Might", "=ds=#s1#, #a4# =q7=#db28#" },
		{ 25004, "INV_Shoulder_15", "=q4=Shoulderblades of Might", "=ds=#s3#, #a4# =q7=#db31#" },
		{ 25006, "INV_Chest_Plate16", "=q4=Chestpiece of Might", "=ds=#s5#, #a4# =q7=#db32#" },
		{ 25000, "INV_Bracer_19", "=q4=Bindings of Might", "=ds=#s8#, #a4# =q7=#x34# (#z1#)" },
		{ 25002, "INV_Gauntlets_10", "=q4=Handguards of Might", "=ds=#s10#, #a4# =q7=#db25#" },
		{ 25001, "INV_Belt_09", "=q4=Girdle of Might", "=ds=#s10#, #a4# =q7=#x34# (#z1#)" },
		{ 25005, "INV_Pants_04", "=q4=Legguards of Might", "=ds=#s11#, #a4# =q7=#db26#" },
		{ 25003, "INV_Boots_Plate_04", "=q4=Greaves of Might", "=ds=#s12#, #a4# =q7=#db27#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 25015, "INV_Helmet_09", "=q4=Greathelm of Wrath", "=ds=#s1#, #a4# =q7=#db28#" },
		{ 25012, "INV_Shoulder_15", "=q4=Shoulderblades of Wrath", "=ds=#s3#, #a4# =q7=#db31#" },
		{ 25014, "INV_Chest_Plate16", "=q4=Chestpiece of Wrath", "=ds=#s5#, #a4# =q7=#db32#" },
		{ 25008, "INV_Bracer_19", "=q4=Bindings of Wrath", "=ds=#s8#, #a4# =q7=#x34# (#z1#)" },
		{ 25010, "INV_Gauntlets_10", "=q4=Handguards of Wrath", "=ds=#s10#, #a4# =q7=#db25#" },
		{ 25009, "INV_Belt_09", "=q4=Girdle of Wrath", "=ds=#s10#, #a4# =q7=#x34# (#z1#)" },
		{ 25013, "INV_Pants_04", "=q4=Legguards of Wrath", "=ds=#s11#, #a4# =q7=#db26#" },
		{ 25011, "INV_Boots_Plate_04", "=q4=Greaves of Wrath", "=ds=#s12#, #a4# =q7=#db27#" },
	};
	T1Paladin1 = {
		{ 0, "", "", "" },
		{ 0, "Spell_Holy_SealOfMight", "=q16=#t1s4#", "" },
		{ 0, "", "", "" },
		{ 25023, "INV_Helmet_05", "=q4=Lawbringer Helm", "=ds=#s1#, #a4# =q7=#db28#" },
		{ 25020, "INV_Shoulder_20", "=q4=Lawbringer Spaulders", "=ds=#s3#, #a4# =q7=#db29#" },
		{ 25022, "INV_Chest_Plate03", "=q4=Lawbringer Chestguard", "=ds=#s5#, #a4# =q7=#db32#" },
		{ 25016, "INV_Bracer_18", "=q4=Lawbringer Bindings", "=ds=#s8#, #a4# =q7=#x34# (#z1#)" },
		{ 25018, "INV_Gauntlets_29", "=q4=Lawbringer Gloves", "=ds=#s10#, #a4# =q7=#db27#" },
		{ 25017, "INV_Belt_27", "=q4=Lawbringer Girlde", "=ds=#s10#, #a4# =q7=#x34# (#z1#)" },
		{ 25021, "INV_Pants_04", "=q4=Lawbringer Legplates", "=ds=#s11#, #a4# =q7=#db26#" },
		{ 25019, "INV_Boots_Plate_09", "=q4=Lawbringer Boots", "=ds=#s12#, #a4# =q7=#db25#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 25031, "INV_Helmet_05", "=q4=Righteous Helm", "=ds=#s1#, #a4# =q7=#db28#" },
		{ 25028, "INV_Shoulder_20", "=q4=Righteous Shoulderplates", "=ds=#s3#, #a4# =q7=#db29#" },
		{ 25030, "INV_Chest_Plate03", "=q4=Righteous Chestguard", "=ds=#s5#, #a4# =q7=#db32#" },
		{ 25024, "INV_Bracer_18", "=q4=Righteous Bindings", "=ds=#s8#, #a4# =q7=#x34# (#z1#)" },
		{ 25026, "INV_Gauntlets_29", "=q4=Righteous Handguards", "=ds=#s10#, #a4# =q7=#db27#" },
		{ 25025, "INV_Belt_27", "=q4=Righteous Girlde", "=ds=#s10#, #a4# =q7=#x34# (#z1#)" },
		{ 25029, "INV_Pants_04", "=q4=Righteous Legplates", "=ds=#s11#, #a4# =q7=#db26#" },
		{ 25027, "INV_Boots_Plate_09", "=q4=Righteous Boots", "=ds=#s12#, #a4# =q7=#db25#" },
	};
	T1Paladin2 = {
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 25039, "INV_Helmet_05", "=q4=Judgement Crown", "=ds=#s1#, #a4# =q7=#db28#" },
		{ 25036, "INV_Shoulder_20", "=q4=Judgement Spaulders", "=ds=#s3#, #a4# =q7=#db29#" },
		{ 25038, "INV_Chest_Plate03", "=q4=Judgement Breastplate", "=ds=#s5#, #a4# =q7=#db32#" },
		{ 25032, "INV_Bracer_18", "=q4=Judgement Bindings", "=ds=#s8#, #a4# =q7=#x34# (#z1#)" },
		{ 25034, "INV_Gauntlets_29", "=q4=Judgement Gauntlets", "=ds=#s10#, #a4# =q7=#db27#" },
		{ 25033, "INV_Belt_27", "=q4=Judgement Belt", "=ds=#s10#, #a4# =q7=#x34# (#z1#)" },
		{ 25037, "INV_Pants_04", "=q4=Judgement Legplates", "=ds=#s11#, #a4# =q7=#db26#" },
		{ 25035, "INV_Boots_Plate_09", "=q4=Judgement Sabatons", "=ds=#s12#, #a4# =q7=#db25#" },
	};
	T0Mage = {
		{ 0, "", "", "" },
		...
		{ 16684, "INV_Gauntlets_17", "=q3=Magister's Gloves", "=ds=#s10#, #a1#" },
	...
	T0Priest = {
		...
		{ 16692, "INV_Gauntlets_14", "=q3=Devout Gloves", "=ds=#s10#, #a1#" },
	...
	T0Warlock = {
		...
		{ 16705, "INV_Gauntlets_32", "=q3=Dreadmist Wraps", "=ds=#s10#, #a1#" },
	...
	T0Rogue = {
		...
		{ 16712, "INV_Gauntlets_24", "=q3=Shadowcraft Gloves", "=ds=#s10#, #a2#" },
	...
	T0Druid = {
		...
		{ 16717, "INV_Gauntlets_17", "=q3=Wildheart Gloves", "=ds=#s10#, #a2#" },
	...
	T0Hunter = {
		...
		{ 16676, "INV_Gauntlets_10", "=q3=Beaststalker's Gloves", "=ds=#s10#, #a3#" },
	...
	T0Shaman = {
		...
		{ 16672,"INV_Gauntlets_11","=q3=Gauntlets of Elements", "=ds=#s10#, #a3#" },
	...
	T0Warrior = {
		...
		{ 16737, "INV_Gauntlets_26", "=q3=Gauntlets of Valor", "=ds=#s10#, #a4#" },
	...
	T0Paladin = {
		...
		{ 16724, "INV_Gauntlets_19", "=q3=Lightforge Gauntlets", "=ds=#s10#, #a4#" },
