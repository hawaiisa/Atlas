...
AL:RegisterTranslations("enUS", function() return {
	...
	["Parent not found"] = " - Parent not found: AtlasLoot_TableNames might be missing entries. Please report this message to Thiri via the V+ Discord or https://github.com/hawaiisa/Atlas";
	["Options"] = true;
	["Collections"] = true;
	["Factions"] = true;
	["World Events"] = true;
