AtlasLoot_Data["AtlasLootRepItems"] = {
	...
	Argent3 = {
		...
		{ 26095, "INV_Hammer_04", "=q4=Herald of Holy Words", "=ds=#w6#, #h3#" },
		{ 26096, "INV_Shield_05", "=q4=Bulwark of the Stoic One", "=ds=#w8#" },
		{ 26097, "INV_Jewelry_Ring_43", "=q4=Exorcism Ring", "=ds=#s13#, #m8#" },
		{ 26098, "INV_Jewelry_Ring_39", "=q4=Signet of the Great Purge", "=ds=#s13#, #m8#" },
	};
	AQBroodRings = {
		{ 0, "", "", "" },
	...
	Timbermaw = {
		...
		{ 16768, "INV_Misc_Bag_11", "=q3=Furbolg Medicine Pouch", "=ds=#s15#" },
		{ 16769, "INV_Mace_11", "=q3=Furbolg Medicine Totem", "=ds=#h3#, #w6#" },
		...
		{ 26101, "INV_Misc_Pelt_Bear_03", "=q4=Alpha\'s Poncho", "=ds=#s4#" },
		{ 26102, "INV_Misc_Pelt_Bear_Ruin_02", "=q4=Beta\'s Poncho", "=ds=#s4#" },
		{ 26103, "INV_Helmet_04", "=q4=Timbermaw Tribal Headdress", "=ds=#s1#, #a1#" },
	};
	Thorium1 = {
		{ 0, "", "", "" },
		{ 0, "INV_Ingot_Mithril", "=q6=#r2#", "" },
		{ 17051, "INV_Scroll_03", "=q4=Plans: Dark Iron Bracers", "=ds=#p2# (295)" },
		{ 17018, "INV_Scroll_03", "=q4=Pattern: Flarecore Gloves", "=ds=#p8# (300)" },
		{ 17023, "INV_Scroll_03", "=q4=Pattern: Molten Helm", "=ds=#p7# (300)" },
		{ 17022, "INV_Scroll_03", "=q4=Pattern: Corehound Boots", "=ds=#p7# (295)" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		{ 19444, "INV_Misc_Note_01", "=q2=Formula: Enchant Weapon - Strength", "=ds=#p4# (290)" },
		{ 20761, "INV_Scroll_03", "=q2=Recipe: Transmute Elemental Fire", "=ds=#p1# (300)" },
		...
		{ 17017, "INV_Scroll_03", "=q4=Pattern: Flarecore Mantle", "=ds=#p8# (300)" },
		{ 19330, "INV_Scroll_03", "=q4=Pattern: Lava Belt", "=ds=#p7# (300)" },
		{ 17025, "INV_Scroll_03", "=q4=Pattern: Black Dragonscale Boots", "=ds=#p7# (300)" },
		{ 17053, "INV_Scroll_03", "=q4=Plans: Fiery Chain Shoulders", "=ds=#p2# (300)" },
	};
	Thorium2 = {
		{ 0, "", "", "" },
		{ 0, "INV_Ingot_Mithril", "=q6=#r4#", "" },
		{ 19448, "INV_Misc_Note_01", "=q3=Formula: Enchant Weapon - Mighty Spirit", "=ds=#p4# (300)" },
		{ 18592, "INV_Scroll_03", "=q4=Plans: Sulfuron Hammer", "=ds=#p2#, #m4#" },
		{ 17052, "INV_Scroll_03", "=q4=Plans: Dark Iron Leggings", "=ds=#p2# (300)" },
		{ 19333, "INV_Scroll_03", "=q4=Pattern: Molten Belt", "=ds=#p7# (300)" },
		{ 19331, "INV_Scroll_03", "=q4=Pattern: Chromatic Gauntlets", "=ds=#p7# (300)" },
		{ 19208, "INV_Scroll_03", "=q4=Plans: Black Amnesty", "=ds=#p2# (300)" },
		{ 19209, "INV_Scroll_03", "=q4=Plans: Blackfury", "=ds=#p2# (300)" },
		{ 19219, "INV_Scroll_03", "=q4=Pattern: Flarecore Robe", "=ds=#p8# (300)" },
		{ 19206, "INV_Scroll_03", "=q4=Plans: Dark Iron Helm", "=ds=#p2# (300)" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		{ 20040, "INV_Scroll_03", "=q4=Plans: Dark Iron Boots", "=ds=#p2# (300)" },	
		{ 19210, "INV_Scroll_03", "=q4=Plans: Ebon Hand", "=ds=#p2# (300)" },  
		{ 19211, "INV_Scroll_03", "=q4=Plans: Blackguard", "=ds=#p2# (300)" }, 
		{ 19212, "INV_Scroll_03", "=q4=Plans: Nightfall", "=ds=#p2# (300)" },
		{ 19220, "INV_Scroll_03", "=q4=Pattern: Flarecore Leggings", "=ds=#p8# (300)" },
		{ 19332, "INV_Scroll_03", "=q4=Pattern: Corehound Belt", "=ds=#p7# (300)" },
		{ 19207, "INV_Scroll_03", "=q4=Plans: Dark Iron Gauntlets", "=ds=#p2# (300)" },
		{ 19449, "INV_Scroll_03", "=q4=Formula: Enchant Weapon - Mighty Intellect", "=ds=#p4# (300)" },
	};
	Cenarion1 = {
		{ 0, "", "", "" },
		{ 22772, "INV_Scroll_03", "=q2=Pattern: Sylvan Shoulders", "=ds=#p8# (300)" },
		{ 22769, "INV_Scroll_03", "=q2=Pattern: Bramblewood Belt", "=ds=#p7# (300)" },
		{ 20506, "INV_Scroll_03", "=q2=Pattern: Spitfire Bracers", "=ds=#p7# (300)" },
		{ 20509, "INV_Scroll_03", "=q2=Pattern: Sandstalker Bracers", "=ds=#p7# (300)" },
		{ 22768, "INV_Scroll_03", "=q2=Plans: Ironvine Belt", "=ds=#p2# (300)" },
		{ 22310, "INV_Scroll_03", "=q2=Pattern: Cenarion Herb Bag", "=ds=#p8# (275)" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
	...
	Cenarion2 = {
		{ 0, "", "", "" },
		{ 22773, "INV_Scroll_03", "=q3=Pattern: Sylvan Crown", "=ds=#p8# (300)" },
		{ 22770, "INV_Scroll_03", "=q3=Pattern: Bramblewood Boots", "=ds=#p7# (300)" },
		{ 20507, "INV_Scroll_03", "=q3=Pattern: Spitfire Gauntlets", "=ds=#p7# (300)" },
		{ 20510, "INV_Scroll_03", "=q3=Pattern: Sandstalker Gauntlets", "=ds=#p7# (300)" }, 
		{ 22767, "INV_Scroll_03", "=q3=Plans: Ironvine Gloves", "=ds=#p2# (300)" },
		{ 22214, "INV_Scroll_03", "=q3=Plans: Light Obsidian Belt", "=ds=#p2# (300)" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
	...
	Cenarion3 = {
		{ 0, "", "", "" },
		{ 22683, "INV_Scroll_03", "=q4=Pattern: Gaea's Embrace", "=ds=#p8# (300)" },
		{ 22774, "INV_Scroll_03", "=q4=Pattern: Sylvan Vest", "=ds=#p8# (300)" },
		{ 22771, "INV_Scroll_03", "=q4=Pattern: Bramblewood Helm", "=ds=#p7# (300)" },
		{ 20508, "INV_Scroll_03", "=q4=Pattern: Spitfire Breastplate", "=ds=#p7# (300)" },
		{ 20511, "INV_Scroll_03", "=q4=Pattern: Sandstalker Breastplate", "=ds=#p7# (300)" },
		{ 22766, "INV_Scroll_03", "=q4=Plans: Ironvine Breastplate", "=ds=#p2# (300)" },
		{ 22312, "INV_Scroll_03", "=q4=Pattern: Satchel of Cenarius", "=ds=#p8# (300)" },
		{ 20732, "INV_Misc_Note_01", "=q4=Formula: Enchant Cloak - Greater Fire Resistance", "=ds=#p4# (300)" },
		{ 22209, "INV_Scroll_03", "=q4=Plans: Heavy Obsidian Belt", "=ds=#p2# (300)" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
	...
	Cenarion4 = {
		{ 0, "", "", "" },
		{ 20382, "INV_Scroll_03", "=q4=Pattern: Dreamscale Breastplate", "=ds=#p7# (300)" },
		{ 22221, "INV_Scroll_03", "=q4=Plans: Obsidian Mail Tunic", "=ds=#p2# (300)" },
		{ 22219, "INV_Scroll_03", "=q4=Plans: Jagged Obsidian Shield", "=ds=#p2# (300)" },
		{ 20733, "INV_Misc_Note_01", "=q4=Formula: Enchant Cloak - Greater Nature Resistance", "=ds=#p4# (300)" },
		{ 26104, "INV_Potion_13", "=q4=Vial of Elune\'s Light", "=ds=#s14#, #m8#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
	...
	Shendralar1 = {
		...
		{ 0, "", "", "" },
		{ 34401, "INV_Misc_Book_10", "=q3=Old Heavy Folio", "=ds=#e22#" },

	};
	Shendralar2 = {
		{ 0, "", "", "" },
		{ 0, "INV_Misc_Note_06", "=q6=#r2#", "" },
		{ 0, "", "", "" },
	...
	Shendralar3 = {
		...
		{ 23684, "INV_Misc_Bandage_16", "=q1=Magic Infused Bandage", "#p6# (300)" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
